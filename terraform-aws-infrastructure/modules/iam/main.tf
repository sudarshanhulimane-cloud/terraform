# IAM Module - Roles and Policies for EC2, EKS, and S3
...
# EC2 Instance Policy for S3 access
...
# EC2 Instance Policy for CloudWatch
...
resource "aws_iam_policy" "eks_s3_policy" {
  ...
  description = "Policy for EKS nodes to access S3"
...
# CloudWatch policy for EKS nodes
resource "aws_iam_role_policy_attachment" "eks_cloudwatch_attachment" {
  role       = aws_iam_role.eks_node_group_role.name
  policy_arn = aws_iam_policy.ec2_cloudwatch_policy.arn
}

# SSM policy for EKS nodes
resource "aws_iam_role_policy_attachment" "eks_ssm_attachment" {
  role       = aws_iam_role.eks_node_group_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}